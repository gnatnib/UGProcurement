                ...
                <form action="{{ url('/admin/updateProfile') . '/' . $data->user_id }}" method="POST" name="myFormUpdate"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="divisi" value="{{ $data->divisi }}" class="form-control"
                                id="divisi" placeholder="Divisi" readonly>
                        </div>

                        <div class="form-group">
                            <label for="departemen">Departemen</label>
                            <input type="text" name="departemen" value="{{ $data->departemen }}"
                                class="form-control" id="departemen" placeholder="Departemen" readonly>
                        </div>
                        <div class="form-group">
