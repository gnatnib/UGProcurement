...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $data["user"] = UserModel::orderBy('user_id', 'DESC')->count();
        $data["bm"] = BarangmasukModel::leftJoin('tbl_barang', 'tbl_barang.barang_kode', '=', 'tbl_barangmasuk.barang_kode')->leftJoin('tbl_user', 'tbl_user.user_id', '=', 'tbl_barangmasuk.user_id')->orderBy('bm_id', 'DESC')->count();
